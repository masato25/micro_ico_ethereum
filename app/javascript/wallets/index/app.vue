<template>
  <div class="wallet_body col-10">
    <el-card class="box-card">
      ...
      <div>
        address: <el-input v-model="contractAddr"></el-input>
        abi: <el-input
          type="textarea"
          :autosize="{ minRows: 2, maxRows: 10}"
          placeholder="please input abi"
          v-model="abicontext">
        </el-input>
        <el-button type="success" @click="generateContract()">Access</el-button>
      </div>
    </el-card>
    <el-card class="box-card">
      <div slot="header" class="clearfix">
